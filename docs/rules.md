...
- As posições são secretas, entao o adversário não vê o tabuleiro do oponente
...
```
acoes(s) = { (r, c) | 0 ≤ r, c ≤ 9  e  (r, c) ∉ s.ataques }
```
...
- **Custo mínimo**: 17 - acertar diretamente todas as células de navios sem nenhum erro
- **Custo máximo**: 100 - atacar todas as 100 células do tabuleiro
